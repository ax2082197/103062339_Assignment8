...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputIP = (EditText) findViewById(R.id.IPNum);
        btnIP = (Button) findViewById(R.id.IPButton);
        IPHint = (TextView) findViewById(R.id.IPHint);
        btnIP.setOnClickListener(new Button.OnClickListener() {
            @Override
    ...
    public void onClick(View v) {
        ...
        Thread t = new thread(num1, num2,result);
        t.start();
    ...
    class thread extends Thread{
        ...
        public thread(float num1, float num2, float result){
            this.num1 = num1;
            this.num2 = num2;
            this.result = result;
        }
        public void run(){
            try{
                ...
                Socket socket = new Socket( IPAddr, 2000);
                System.out.println("Connected!");

                // Create stream communicate with server
                OutputStream out = socket.getOutputStream();
                String strToSend =new String(num1 + " " + oper + " " + num2 + " = " + result);
